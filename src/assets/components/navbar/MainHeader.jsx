...
const MainHeader = () => {
    ...
    const handleOpenMenu = () => {
        setNavClass(
            "absolute top-0 left-0 flex h-full w-3/5 flex-col gap-y-[21px]  p-2 font-bold md:static md:mr-auto md:flex md:flex-row md:gap-4 md:p-0 md:h-auto"
        );
    };
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 z-50 bg-white container mx-auto flex items-center gap-8 p-4 md:p-0">
                ...
                <img
                    src={LogoTribu}
                    alt="Logo Tribu"
                    className="mr-auto mb-1 h-8 md:mr-0"
                />
